<?php
    ...
    // for testing of new functionality
...
<link rel="stylesheet" type="text/css" media="screen" href="/css/autosuggest_inquisitor.css" charset="utf-8" />
    ...
    <!--alpha.transitcompass.com-->
    <script src="http://maps.google.com/maps?file=api&v=2&key=ABQIAAAAXJk3_ifz0EKtxl6PfNqOdRSTymULI7KIU-_0CELD0pcOfjOkPxRK3WUE7RdX1GaQOxeFRbhUj17uIw" type="text/javascript"></script>
    <!--transitcompass.com-->
  ...
  <div id="message">
    Currently under development. Some new features underway!
  </div>
<?php
    // set the type
    $type = $_GET['type'];
