<?php
    ...
    // default page
        ...
        if ($state == "NY") {
            echo "(i.e. <a href=\"/nyc/?sa=50+Wall+St\">50 Wall St</a>)<br/>";
        }
        echo "<br/>\n";
        echo "Find <i>directions</i> by entering a start address and an end address.<br/>";
        if ($state == "NY") {
            echo "(i.e. <a href=\"/nyc/?sa=1032+Greene+Ave%2C+Brooklyn%2C+NY&da=1585+Broadway\">1032 Greene Ave, Brooklyn to 1585 Broadway</a>)<br/>";
        }
        echo "<br/>\n";
        echo "Find <i>directions</i> by entering a starting station name and an ending station name.<br/>";
        if ($state == "NY") {
            echo "(i.e. <a href=\"/nyc/?sa=Forest+Hills-71st+Ave&da=Brooklyn+Bridge-City+Hall&sid=SFH71AEFGRV&did=SBBCH456\">Forest Hills-71st Ave to Brooklyn Bridge-City Hall</a>)<br/>";
        }
        echo "<br/>\n";
        echo "Or you can enter any combination of station name or address!<br/>";
        if ($state == "NY") {
            echo "(i.e. <a href=\"/nyc/?sa=Forest+Hills-71st+Ave&sid=SFH71AEFGRV&da=1585+Broadway\">Forest Hills-71st Ave to 1585 Broadway</a>)\n";
        }
        echo "</div>\n";
    }
?>