<?php
    ...
    */
    ...
    $da = $_GET['da'];
    /*
        Javascript calculates time on milliseconds. PHP calculates time on seconds.
    */
    //$time = floor($_GET['t']/1000);
    $time_string = $_GET['time_string'];
    if ($time_string == "") {
        $time = time();
    }
    else {
    ...
    if ($type == "dir") {
        ...
        if ((count($starts) == 1) && (count($ends) == 1)) {
            ...
            algorithm($start_location, $end_location);
