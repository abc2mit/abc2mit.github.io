...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml">
  <head>
    ...
    <title>bostonsubway.info // from a to b. through the T.</title>
  </head>
  <body>
  <?php
    include('../subwaydb/db.php');
    // connect to database
    connectDB("digressi_boston");
    //$markers = array();
    //$file = "nyc_time.xml";
...
<tr>
	<td class="logo">
		<a href="http://www.bostonsubway.info">
		<img id="logo" src="images/bostonsubway.png" alt="Go To bostonsubway.info" height="55" width="150">
		</a>
	</td>
    <td width="100%">
            ...
            <td style="vertical-align: top;">
                <table>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="boxlabel">
                                Location Address&nbsp;&nbsp;<span class="example">e.g., 400 Memorial Drive, Cambridge, MA</span>
                            </td>
                        </tr>
                        </tbody>
                        </table>
                        ...
                        <tr>
                            <td class="boxlabel">
                                Start&nbsp;&nbsp;<span class="example">e.g., Alewife</span>
                            </td>
                            <td class="boxlabel">
                                End&nbsp;&nbsp;<span class="example">e.g., Roxbury Crossing</span>
                            </td>
                        </tr>
                        </tbody>
                        </table>
...
<table id="headertitle">
    <tbody>
        <tr>
        <td class="title">The T | Massachusetts Bay Transporation Authority</td>
        <td id="toggle">&nbsp;</td>
        </tr>
    </tbody>
</table>
...
<b>If you like this site, please tell your friends!</b> The site is written entirely by hand and funded by personal wallets, just to make travel in the Boston area greater and better for you!<br/><br/><i>NOTE: Anything Google can find, we can find. We know (found out) recently that the MBTA had revamped their website. While it looks great, we think that their trip planner could use some work. That's why we have this site here!</i>
</div>
...
<br/><br/>
<div id="other_sites">
If you are in New York City, NY, you can use the same great features for the MTA! Visit the sister site: <a href="http://www.nysubway.info">www.nysubway.info</a>
</div>
